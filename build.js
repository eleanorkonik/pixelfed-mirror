...
<head>
  ...
  <meta name="description" content="An illustrated flash fiction series about interstellar behemoths, human symbiosis, and a frontier world called Pieran.">

  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://mirror.eleanorkonik.com/">
  <meta property="og:title" content="Maven & the Border Lord by Eleanor Konik">
  <meta property="og:description" content="An illustrated flash fiction series about interstellar behemoths, human symbiosis, and a frontier world called Pieran.">
  <meta property="og:image" content="${MANUAL_ENTRIES[0].imageUrl}">
  <meta property="og:site_name" content="Eleanor Konik">

  <!-- Twitter -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:url" content="https://mirror.eleanorkonik.com/">
  <meta name="twitter:title" content="Maven & the Border Lord by Eleanor Konik">
  <meta name="twitter:description" content="An illustrated flash fiction series about interstellar behemoths, human symbiosis, and a frontier world called Pieran.">
  <meta name="twitter:image" content="${MANUAL_ENTRIES[0].imageUrl}">
